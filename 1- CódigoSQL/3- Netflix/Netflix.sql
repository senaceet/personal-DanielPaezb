...
nombre_serie VARCHAR(12) NOT NULL,
...
id_servidor_correo INT(11) NOT NULL,
...
fk_id_tipo_plan INT(11) NOT NULL);
...
fk_id_documento VARCHAR(15) NOT NULL,
fk_id_tipo_pago INT(11) NOT NULL,
...
nombre_pelicula VARCHAR(12) NOT NULL);
